...
@router.get(path="/users/email/{user_id}")
...
## GetPetInfo
@router.get(path="/users/info/{user_id}")
...
## ChangeUserEmail
@router.put(path="/users/email/{user_id}")
...
## ChangeUserPass
@router.put(path="/users/pass/{user_id}")
...
## ChangePetInfo
@router.put(path="/users/info/{user_id}")
