...
## DeletePost 
@app.delete(path="/post/{user_id}/{post_id}")
...
# GoodCount
@app.get(path="/post/goodcount/{post_id}")
...
## Good
@app.put(path="/post/good/{post_id}")
